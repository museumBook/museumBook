  ...
  <div>
    <div class="wrapper">
      ...
      <video id="video" class="display-none" muted>
        <source id="video-source" src="/static/video/heritage/4_hall.mp4" type="video/mp4">
      </video>
      <audio id="audio">
        <source id="audio-source" src="/static/audio/heritage/4_hall.mp3" type="audio/mp3">
      </audio>
      <div class="welcome">
        ...
        <div id="title-welcome" class="title-welcome emergence-title-welcome">
          <img src='/static/img/heritage/4_hall.png'>
        </div>
      </div>
    </div>
    <div class="down-rooms">
      ...
      <div class="rooms">
        ...
        <div>
          <router-link to='/heritage/hall/4' class="num-room num-room-active emergence-num-room-active">IV</router-link>
        </div>
      </div>
