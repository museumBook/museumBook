  ...
  <div>
    <div class="wrapper">
      ...
      <!-- <video id="video" class="display-none" controls> -->
        <source id="video-source" src="/static/video/heritage/2_hall.mp4" type="video/mp4">
      </video>
      <!-- <audio id="audio">
      ...
      <div class="welcome">
        ...
        <div id="title-welcome" class="title-welcome emergence-title-welcome">
          <img src='/static/img/heritage/2_hall.png'>
        </div>
      </div>
    </div>
    <div class="down-rooms">
      ...
      <div class="rooms">
        ...
        <div>
          <router-link to='/heritage/hall/2' class="num-room num-room-active emergence-num-room-active">II</router-link>
        </div>
        <div>
