  ...
  <div>
    <div id="wrapper" class="wrapper">
      ...
      <video id="video" class="display-none" muted>
        <source id="video-source" src="/static/video/ust_cilma/1_hall.mp4" type="video/mp4">
      </video>
      <!-- <audio id="audio">
      ...
      <div class="welcome">
        ...
        <div id="title-welcome" class="title-welcome emergence-title-welcome">
          <img src='/static/img/ust_cilma/1_hall.png'>
        </div>
      </div>
    </div>
    <div class="down-rooms">
      ...
      <div class="rooms">
        <div>
          <router-link to='/ust-cilma/hall/1' class="num-room num-room-active emergence-num-room-active">I</router-link>
        </div>
        <div>
          <router-link to='/ust-cilma/hall/2' class="num-room">II</router-link>
        </div>
        <div>
          <router-link to='/ust-cilma/hall/3' class="num-room">III</router-link>
        </div>
      </div>
      ...
      document.addEventListener("mousemove", e => {
        if (e.clientY > window.innerHeight * 0.75) {
          document.getElementById("down-shadow").style.boxShadow =
            "0px -10px 100px 80px #404040";
        } else {
          document.getElementById("down-shadow").style.boxShadow =
            "0px -10px 100px 50px #404040";
        }
      });
        ...
        function(e) {
          if (e.target.currentTime >= self.videos[self.stage].end) {
            if (self.videos[self.stage].onEnd == "loop") {
              ...
              setTimeout(() => {
                self.$router.push("/ust-cilma/hall/2");
              }, 2000);
            }
          }
...
.down-shadow {
  ...
  box-shadow: 0px -10px 100px 50px #404040;
  width: 100%;
  height: 1px;
  opacity: 0;
}
