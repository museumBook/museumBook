  ...
  <div>
    <div id="wrapper" class="wrapper">
      ...
      <video id="video" class="display-none" muted>
        <source id="video-source" src="/static/video/ust_cilma/3_hall.mp4" type="video/mp4">
      </video>
      <!-- <audio id="audio">
      ...
      <div class="welcome">
        ...
        <div id="title-welcome" class="title-welcome emergence-title-welcome">
          <img src='/static/img/ust_cilma/3_hall.png'>
        </div>
      </div>
    </div>
    <div class="down-rooms">
      ...
      <div class="rooms">
        ...
        <div>
          <router-link to='/ust-cilma/hall/3' class="num-room num-room-active emergence-num-room-active">III</router-link>
        </div>
      </div>
