  ...
  <div>
    <div id="wrapper" class="wrapper">
      ...
      <video id="video" class="display-none" muted>
        <source id="video-source" src="/static/video/ust_cilma/2_hall.mp4" type="video/mp4">
      </video>
      <!-- <audio id="audio">
      ...
      <div class="welcome">
        ...
        <div id="title-welcome" class="title-welcome emergence-title-welcome">
          <img src='/static/img/ust_cilma/2_hall.png'>
        </div>
      </div>
    </div>
    <div class="down-rooms">
      ...
      <div class="rooms">
        <div>
          <router-link to='/ust-cilma/hall/1' class="num-room">I</router-link>
        </div>
        <div>
          <router-link to='/ust-cilma/hall/2' class="num-room num-room-active emergence-num-room-active">II</router-link>
        </div>
        <div>
        ...
        function(e) {
          if (e.target.currentTime >= self.videos[self.stage].end) {
            if (self.videos[self.stage].onEnd == "loop") {
              ...
              setTimeout(() => {
                self.$router.push("/ust-cilma/hall/3");
              }, 2000);
            }
          }
