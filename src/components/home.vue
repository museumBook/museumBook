...
export default {
  ...
  methods:{
    init: function(){
      ...
      document.getElementById('load-home').className = 'background-home load-home emergence-load-home';
      ...
      setTimeout(()=>{
        ...
        setTimeout(()=>{
          ...
          document.getElementById('room1').addEventListener('mouseover', function(e){
            e.target.setAttribute('src', '/static/img/homePage/room1hover.png');
          });

          document.getElementById('room1').addEventListener('mouseleave', function(e){
            e.target.setAttribute('src', '/static/img/homePage/room1.png');
          });

          document.getElementById('room2').addEventListener('mouseover', function(e){
            e.target.setAttribute('src', '/static/img/homePage/room2hover.png');
          });

          document.getElementById('room2').addEventListener('mouseleave', function(e){
    ...
    resize: function(){
      ...
      document.getElementById('load-home').style.height = max_height * 960 / 1080 + 'px';
      document.getElementById('static-home').style.height = max_height * 960 / 1080 + 'px';

      document.getElementById('load-home').style.width = max_width * 1706 / 1920 + 'px';
      document.getElementById('static-home').style.width = max_width * 1706 / 1920 + 'px';

      document.getElementById('load-home').style.left = max_width * 107 / 1920 + width_offset + 'px';
      document.getElementById('static-home').style.left = max_width * 107 / 1920 + width_offset + 'px';

      document.getElementById('room1').style.height = max_height * 200 / 1080 + 'px';
      document.getElementById('room2').style.height = max_height * 200 / 1080 + 'px';

      document.getElementById('rooms').style.top = max_height * 860 / 1080 + 'px';

      document.getElementById('quote1').style.top = max_height * 360 / 1080 + 'px';
      document.getElementById('quote1').style.left = max_width * 100 / 1920 + width_offset + 'px';
      document.getElementById('quote1').style.width = max_width * 380 / 1920 + 'px';
      document.getElementById('quote1').style.fontSize = max_width * 22 / 1920 + 'px';

      document.getElementById('quote2').style.top = max_height * 570 / 1080 + 'px';
      document.getElementById('quote2').style.left = max_width * 1470 / 1920 + width_offset + 'px';
      document.getElementById('quote2').style.width = max_width * 445 / 1920 + 'px';
      document.getElementById('quote2').style.fontSize = max_width * 22 / 1920 + 'px';
    }
  }
}
</script>
